...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/newtexture.vert", "shaders/newtexture.frag"),
			new CGFshader(this.gl, "shaders/newtexture2.vert", "shaders/newtexture2.frag"),
			new CGFshader(this.gl, "shaders/texture1.vert", "shaders/sepiabased.frag"),
