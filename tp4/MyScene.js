...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        //UnitCubeQuad Textures
        this.texture4 = new CGFtexture(this, 'images/mineTop.png');
        this.texture51 = new CGFtexture(this, 'images/mineSide.png');
        this.texture52 = new CGFtexture(this, 'images/mineSide.png');
        this.texture53 = new CGFtexture(this, 'images/mineSide.png');
        this.texture54 = new CGFtexture(this, 'images/mineSide.png');
        this.texture6 = new CGFtexture(this, 'images/mineBottom.png');
        this.cubetextures = [this.texture4, this.texture51, this.texture52, this.texture53, this.texture54, this.texture6];
        //------
        ...
        this.unitcubequad = new MyUnitCubeQuad(this, this.cubetextures);
