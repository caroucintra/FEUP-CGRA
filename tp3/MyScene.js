...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.objects = [this.plane, this.pyramid, this.cone, this.tangram,
        this.unitcube, this.triangle];

        // Labels and ID's for object selection on MyInterface
        this.objectIDs = { 'Plane': 0 , 'Pyramid': 1, 'Cone': 2, 'Tangram' : 3,
        'UnitCube' : 4, 'Triangle' : 5, 'Diamond' : 6};
    ...
    initLights() {
        //this.setGlobalAmbientLight(this.ambientLightIntensity, this.ambientLightIntensity,
    ...
    initMaterials() {
        ...
        //this.tangram.initMaterials(this);
    }
